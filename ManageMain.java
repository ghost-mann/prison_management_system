...
public class ManageMain extends JFrame implements ActionListener 
{
  ...
  public JButton btnpadd, btnpdel, btnprls, btnpdsp, btnpdspall, btnwadd, btnwdel, btnwdspall, btnwclr, btnpclr, btnlogin,btnreg;
  ...
  public void actionPerformed(ActionEvent e)
	{
		...
		else if (e.getSource() == menucheck)
		{
	        ...
	        try{
	            ...
	            Connection connect=DriverManager.getConnection("jdbc:mysql://localhost:3308/prison");
	            Statement state=connect.createStatement();
	            //sql statement to check all prisoners that are in prison
	            String sql="select * from prison where status='inprison'";
